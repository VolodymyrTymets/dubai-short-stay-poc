  ...
  return (
    <div className="flex min-h-screen bg-page">
      <aside className="w-64 shrink-0 flex flex-col gap-4 p-4">
        ...
        {/* TODO: wire activeId/onSelect once Listings/Calendar/Reservations/Messages/Earnings/
            Verification/Settings each have a real route — this ticket only adds Home/Sign In/Sign Up. */}
        <Sidebar items={mainNavItems} />
        <Sidebar groupLabel="Account" items={accountNavItems} />
        <div className="flex-1" />
        {/* TODO: replace with the signed-in Host's real name/DET permit once account data is wired. */}
